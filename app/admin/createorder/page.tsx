        ...
        <>
          ...
          <div className="space-y-4 mb-6">
            {selectedItems.map((item) => (
              ...
              >
                {/* Main Card Content */}
                <div className="p-2 border-1 rounded-4xl bg-white shadow-sm">
                  <div className="flex items-start space-x-4">
                    {/* Image */}
                    <div className="flex-shrink-0">
                      <div className="w-24 h-24 rounded-tl-3xl rounded-bl-3xl rounded-tr-lg rounded-br-lg overflow-hidden">
                        {item.imageUrl ? (
                          <img
                            src={item.imageUrl}
                            alt={item.name}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between h-full">
                        <div className="flex-1">
                          <h3 className="text-lg font-medium text-typography-heading mt-2">
                            {item.name}
                          </h3>
                          <h4 className="text-lg font-semibold text-typography-heading mt-1">
